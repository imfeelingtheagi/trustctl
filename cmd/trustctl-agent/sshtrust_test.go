...
const testCALine = "ecdsa-sha2-nistp256 AAAAtestcakey ca@trustctl\n"
...
func TestAgentSSHTrustAddsCAAdditively(t *testing.T) {
	...
	if !strings.Contains(string(trust), "ca@trustctl") || !strings.Contains(string(trust), "other-ca@corp") {
