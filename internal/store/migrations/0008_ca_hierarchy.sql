...
-- entities for operating certctl as its own CA — the CA hierarchy and its
...
-- ca_authorities is the CA hierarchy: each root or intermediate certctl operates,
...
GRANT SELECT, INSERT, UPDATE, DELETE ON ca_authorities TO certctl_app;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON ca_key_ceremonies TO certctl_app;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON ca_ceremony_approvals TO certctl_app;
