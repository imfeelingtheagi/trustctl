// Package directive detects certctl marker comments such as
// //certctl:keymaterial, //certctl:repository, and //certctl:mutation.
//
...
// (for example "certctl:keymaterial") as a standalone line comment.
