...
// //trustctl:keymaterial marker, after which any string-typed struct field,
...
var Analyzer = &analysis.Analyzer{
	Name: "keymaterial",
	Doc:  "AN-8: packages marked //trustctl:keymaterial must not use string for key material; use []byte.",
	Run:  run,
}
